...
USER FUNCTION Z061VIS()
    LOCAL aArea, aAreaBM, nOpcao, cCadastro

    aArea := FWGetArea()
    aAreaBM := SBM:FWGetArea()
    nOpcao := 0
    cCadastro := "Teste de Visualização"
    // Chama a função
