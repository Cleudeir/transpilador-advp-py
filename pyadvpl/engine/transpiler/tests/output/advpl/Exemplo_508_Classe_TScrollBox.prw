...
USER FUNCTION zExe508()
    LOCAL aArea, nCorFundo, nJanAltura, nJanLargur, cJanTitulo, lDimPixels, lCentraliz, nObjLinha, nObjColun, nObjLargu, nObjAltur, cFontNome, oFontPadrao, oScroll, bBlocoIni, oSayObj0, cSayObj0, oGetObj1, xGetObj1, oSayObj2, cSayObj2, oGetObj3, xGetObj3, oSayObj4, cSayObj4, oGetObj5, xGetObj5, oSayObj6, cSayObj6, oGetObj7, xGetObj7, oSayObj8, cSayObj8, oGetObj9, xGetObj9, oSayObj10, cSayObj10, oGetObj11, xGetObj11, oSayObj12, cSayObj12, oGetObj13, xGetObj13, oBtnObj14, cBtnObj14, bBtnObj14, oDialogPvt
    ...
    nObjLargu := 40
    nObjAltur := 6
    oSayObj0 := TSay():New(nObjLinha, nObjColun, Nil, oScroll, Nil, oFontPadrao, Nil, Nil, Nil, lDimPixels, Nil, Nil, nObjLargu, nObjAltur, Nil, Nil, Nil, Nil, Nil)
    // objeto1 - usando a classe TGet
    nObjLinha := 3
    nObjColun := 49
    nObjLargu := 100
    nObjAltur := 10
    oGetObj1 := TGet():New(nObjLinha, nObjColun, Nil, oScroll, nObjLargu, nObjAltur, Nil, Nil, Nil, Nil, oFontPadrao, Nil, Nil, lDimPixels)
    ...
    nObjLargu := 45
    nObjAltur := 6
    oSayObj2 := TSay():New(nObjLinha, nObjColun, Nil, oScroll, Nil, oFontPadrao, Nil, Nil, Nil, lDimPixels, Nil, Nil, nObjLargu, nObjAltur, Nil, Nil, Nil, Nil, Nil)
    // objeto3 - usando a classe TGet
    nObjLinha := 18
    nObjColun := 49
    nObjLargu := 100
    nObjAltur := 10
    oGetObj3 := TGet():New(nObjLinha, nObjColun, Nil, oScroll, nObjLargu, nObjAltur, Nil, Nil, Nil, Nil, oFontPadrao, Nil, Nil, lDimPixels)
    ...
    nObjLargu := 45
    nObjAltur := 6
    oSayObj4 := TSay():New(nObjLinha, nObjColun, Nil, oScroll, Nil, oFontPadrao, Nil, Nil, Nil, lDimPixels, Nil, Nil, nObjLargu, nObjAltur, Nil, Nil, Nil, Nil, Nil)
    // objeto5 - usando a classe TGet
    nObjLinha := 33
    nObjColun := 49
    nObjLargu := 100
    nObjAltur := 10
    oGetObj5 := TGet():New(nObjLinha, nObjColun, Nil, oScroll, nObjLargu, nObjAltur, Nil, Nil, Nil, Nil, oFontPadrao, Nil, Nil, lDimPixels)
    ...
    nObjLargu := 45
    nObjAltur := 6
    oSayObj6 := TSay():New(nObjLinha, nObjColun, Nil, oScroll, Nil, oFontPadrao, Nil, Nil, Nil, lDimPixels, Nil, Nil, nObjLargu, nObjAltur, Nil, Nil, Nil, Nil, Nil)
    // objeto7 - usando a classe TGet
    nObjLinha := 48
    nObjColun := 49
    nObjLargu := 100
    nObjAltur := 10
    oGetObj7 := TGet():New(nObjLinha, nObjColun, Nil, oScroll, nObjLargu, nObjAltur, Nil, Nil, Nil, Nil, oFontPadrao, Nil, Nil, lDimPixels)
    ...
    nObjLargu := 45
    nObjAltur := 6
    oSayObj8 := TSay():New(nObjLinha, nObjColun, Nil, oScroll, Nil, oFontPadrao, Nil, Nil, Nil, lDimPixels, Nil, Nil, nObjLargu, nObjAltur, Nil, Nil, Nil, Nil, Nil)
    // objeto9 - usando a classe TGet
    nObjLinha := 63
    nObjColun := 49
    nObjLargu := 100
    nObjAltur := 10
    oGetObj9 := TGet():New(nObjLinha, nObjColun, Nil, oScroll, nObjLargu, nObjAltur, Nil, Nil, Nil, Nil, oFontPadrao, Nil, Nil, lDimPixels)
    ...
    nObjLargu := 45
    nObjAltur := 6
    oSayObj10 := TSay():New(nObjLinha, nObjColun, Nil, oScroll, Nil, oFontPadrao, Nil, Nil, Nil, lDimPixels, Nil, Nil, nObjLargu, nObjAltur, Nil, Nil, Nil, Nil, Nil)
    // objeto11 - usando a classe TGet
    nObjLinha := 78
    nObjColun := 49
    nObjLargu := 100
    nObjAltur := 10
    oGetObj11 := TGet():New(nObjLinha, nObjColun, Nil, oScroll, nObjLargu, nObjAltur, Nil, Nil, Nil, Nil, oFontPadrao, Nil, Nil, lDimPixels)
    ...
    nObjLargu := 45
    nObjAltur := 6
    oSayObj12 := TSay():New(nObjLinha, nObjColun, Nil, oScroll, Nil, oFontPadrao, Nil, Nil, Nil, lDimPixels, Nil, Nil, nObjLargu, nObjAltur, Nil, Nil, Nil, Nil, Nil)
    // objeto13 - usando a classe TGet
    nObjLinha := 93
    nObjColun := 49
    nObjLargu := 100
    nObjAltur := 10
    oGetObj13 := TGet():New(nObjLinha, nObjColun, Nil, oScroll, nObjLargu, nObjAltur, Nil, Nil, Nil, Nil, oFontPadrao, Nil, Nil, lDimPixels)
