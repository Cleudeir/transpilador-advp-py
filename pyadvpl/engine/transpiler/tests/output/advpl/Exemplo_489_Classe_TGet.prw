...
USER FUNCTION zExe489()
    LOCAL aArea, nCorFundo, nJanAltura, nJanLargur, cJanTitulo, lDimPixels, lCentraliz, nObjLinha, nObjColun, nObjLargu, nObjAltur, cFontNome, oFontPadrao, oDialogPvt, bBlocoIni, oSayObj0, cSayObj0, oGetObj1, xGetObj1, oSayObj2, cSayObj2, oGetObj3, xGetObj3, oSayObj4, cSayObj4, oGetObj5, xGetObj5, oSayObj6, cSayObj6, oGetObj7, xGetObj7, oSayObj8, cSayObj8, oGetObj9, xGetObj9, oSayObj10, cSayObj10, oGetObj11, xGetObj11, oSayObj12, cSayObj12, oGetObj13, xGetObj13, oBtnObj14, cBtnObj14, bBtnObj14

    aArea := FWGetArea()
    nCorFundo := RGB(238, 238, 238)
    nJanAltura := 281
    nJanLargur := 318
    cJanTitulo := "Exemplo TGet"
    lDimPixels := .T.
    lCentraliz := .T.
    nObjLinha := 0
    nObjColun := 0
