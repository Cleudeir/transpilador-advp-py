...
USER FUNCTION zExe255()
    LOCAL aArea, cMensagem, dData, cHora
    ...
    cMensagem += "1: " + FWTimeStamp(1, dData, cHora) + CRLF
    // aaaammddhhmmss
    cMensagem += "2: " + FWTimeStamp(2, dData, cHora) + CRLF
    // dd/mm/aaaa-hh:mm:ss
    cMensagem += "3: " + FWTimeStamp(3, dData, cHora) + CRLF
    // aaaa-mm-ddThh:mm:ss
    cMensagem += "4: " + FWTimeStamp(4, dData, cHora) + CRLF
    // Total em milissegundos desde 01/01/1970
    cMensagem += "5: " + FWTimeStamp(5, dData, cHora) + CRLF
    // aaaa-mm-ddThh:mm:ss-+Time Zone
    cMensagem += "6: " + FWTimeStamp(6, dData, cHora)
