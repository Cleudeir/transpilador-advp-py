...
USER FUNCTION zExe141()
    LOCAL aArea, dDtHoje, cDiaAtu1, cDiaAbrev, cSabado, cDiaAtu2, cMensagem
    ...
    cDiaAtu1 := DiaSemana(dDtHoje, Nil)
    cDiaAbrev := DiaSemana(dDtHoje, 3, Nil, Nil)
    cSabado := DiaSemana(Nil, Nil, 7)
