...
USER FUNCTION zExe032()
    LOCAL aArea, lGostaLer, dDtNascim, nAltura, cResult
    ...
    cResult += "dDtNascim (YYYYMMDD): " + AllToChar(dDtNascim, Nil, .T.) + CRLF
    cResult += "dDtNascim (DD/MM/YYYY): " + AllToChar(dDtNascim, Nil, .F.) + CRLF
