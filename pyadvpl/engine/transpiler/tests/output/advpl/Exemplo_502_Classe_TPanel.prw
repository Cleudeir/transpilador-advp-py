...
USER FUNCTION zExe502()
    LOCAL aArea, nCorFundo, nJanAltura, nJanLargur, cJanTitulo, lDimPixels, lCentraliz, nObjLinha, nObjColun, nObjLargu, nObjAltur, cFontNome, oFontPadrao, oFontNegrit, oDialogPvt, bBlocoIni, oSayObj0, cSayObj0, oGetObj1, xGetObj1, oSayObj2, cSayObj2, oGetObj3, xGetObj3, oSayObj4, cSayObj4, oGetObj5, xGetObj5, oSayObj6, cSayObj6, oGetObj7, xGetObj7, oSayObj8, cSayObj8, oGetObj9, xGetObj9, oSayObj10, cSayObj10, oGetObj11, xGetObj11, oSayObj12, cSayObj12, oGetObj13, xGetObj13, oBtnObj14, cBtnObj14, bBtnObj14, oPanCampo, oPanBotao
    ...
    oPanCampo := TPanel():New(nObjLinha, nObjColun, "", oDialogPvt, Nil, Nil, Nil, Nil, RGB(255, 200, 200), nObjLargu, nObjAltur)
    ...
    oPanBotao := TPanel():New(nObjLinha, nObjColun, "", oDialogPvt, Nil, Nil, Nil, Nil, RGB(200, 200, 255), nObjLargu, nObjAltur)
