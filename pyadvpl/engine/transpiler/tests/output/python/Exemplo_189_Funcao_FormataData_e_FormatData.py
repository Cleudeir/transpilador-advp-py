...
def u_zExe189():
    ...
    cMensagem = ''
    cMensagem += '#1: ' + FormatData(dDataRef, False, 1) + CRLF
    cMensagem += '#2: ' + FormatData(dDataRef, False, 2) + CRLF
    cMensagem += '#3: ' + FormatData(dDataRef, False, 3) + CRLF
    cMensagem += '#4: ' + FormatData(dDataRef, False, 4) + CRLF
    cMensagem += '#5: ' + FormatData(dDataRef, False, 5) + CRLF
    cMensagem += '#6: ' + FormatData(dDataRef, False, 6) + CRLF
    cMensagem += '#7: ' + FormatData(dDataRef, False, 7) + CRLF
    cMensagem += '#8: ' + FormatData(dDataRef, False, 8) + CRLF
