...
def s_ModelDef():
    ...
    oModel.AddFields('SBMMASTER', None, oStPai)
    oModel.AddGrid('SB1DETAIL', 'SBMMASTER', oStFilho, None, None, None, None)
    # cOwner é para quem pertence
    oModel.AddGrid('SB2DETAIL', 'SB1DETAIL', oStNeto, None, None, None, None)
    # cOwner é para quem pertence
    ...
    oModel.AddCalc('TOT_SALDO', 'SB1DETAIL', 'SB2DETAIL', 'B2_QATU', 'XX_TOTAL', 'SUM', None, None, 'Saldo Total:')
    return oModel
    # ---------------------------------------------------------------------*
    #  | Func:  ViewDef                                                      |
    #  | Autor: Daniel Atilio                                                |
