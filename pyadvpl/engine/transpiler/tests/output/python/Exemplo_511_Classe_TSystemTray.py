...
def fMontaTela():
    ...
    if lProgInic:
        ...
        oMenu = TMenu().New(0, 0, 0, 0, True, None, oDlgCentral)
        oItem1 = TMenuItem().New(oDlgCentral, 'Mudar a Cor de Fundo', None, None, None, lambda : [(nCor := ColorTriangle()), (setattr(oDlgCentral, 'nClrPane', nCor) or nCor), oDlgCentral.Refresh()], None, 'BR_VERDE', None, None, None, None, None, None, True)
        oItem2 = TMenuItem().New(oDlgCentral, 'Exibir Data e Hora', None, None, None, lambda : FWAlertInfo(dToC(Date()) + ' - ' + Time(), 'Atenção'), None, 'HISTORIC', None, None, None, None, None, None, True)
        oItem3 = TMenuItem().New(oDlgCentral, 'Encerrar Aplicação', None, None, None, lambda : oDlgCentral.End(), None, 'EXCLUIR', None, None, None, None, None, None, True)
        oMenu.Add(oItem1)
        oMenu.Add(oItem2)
        oMenu.Add(oItem3)
