...
def u_zExe437():
    ...
    SetKey(K_CTRL_L, lambda : u_zSearch())
    # Atalho:    Shift + F7
    # 		Função:    zIsMVC
    ...
    SetKey(K_SH_F7, lambda : u_zIsMVC())
    # Atalho:    Shift + F8
    # 		Função:    zMiniForm
    ...
    SetKey(K_SH_F11, lambda : u_zTiSQL())
    # Shift + F11
    FWRestArea(aArea)
    return
