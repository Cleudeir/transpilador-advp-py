...
def u_zExe490():
    ...
    oGrpCampo = TGroup().New(nObjLinha, nObjColun, nObjAltur, nObjLargu, 'Labels e Campos:', oDialogPvt, None, None, lDimPixels)
    ...
    oGrpBotao = TGroup().New(nObjLinha, nObjColun, nObjAltur, nObjLargu, '', oDialogPvt, None, None, lDimPixels)
