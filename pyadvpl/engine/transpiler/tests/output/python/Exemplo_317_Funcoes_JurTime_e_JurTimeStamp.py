...
def u_zExe317():
    ...
    cMensagem = '.T. e .T.: ' + JurTime(True, True) + CRLF
    cMensagem += '.T. e .F.: ' + JurTime(True, False) + CRLF
    cMensagem += '.F. e .T.: ' + JurTime(False, True) + CRLF
    cMensagem += '.F. e .F.: ' + JurTime(False, False)
