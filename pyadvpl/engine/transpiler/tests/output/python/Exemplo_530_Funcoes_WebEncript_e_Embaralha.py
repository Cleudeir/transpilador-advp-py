...
def u_zExe530():
    ...
    cWebCript = '\x15VÉk-Ü°\x1b\x02\x91+\x04\x927\x99öÉk,Æ°Û'
    # Monta uma mensagem e exibe
    cMensagem = "O texto '" + cWebNormal + "' cripotografado é: " + WebEncript(cWebNormal, False) + CRLF + CRLF
    cMensagem += "Já o critografado '" + cWebCript + "' é: " + WebEncript(cWebCript, True)
