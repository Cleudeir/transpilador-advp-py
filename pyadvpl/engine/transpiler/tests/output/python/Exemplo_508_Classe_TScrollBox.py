...
#     caso queira ver esse exemplo rodando em vídeo, acesse o seguinte link:     https://terminaldeinformacao.com/2024/06/30/criando-barras-de-rolagem-com-tscrollbox-maratona-advpl-e-tl-508/
# Bibliotecas
# PREPROCESSOR: #Include "TOTVS.ch"
# {Protheus.doc} User Function zExe508
# Cria uma área com barra de rolagem dentro de uma Dialog
# @type Function
# @author Atilio
# @since 04/04/2023
...
def u_zExe508():
    ...
    # RAW: @ 001 , 001 SCROLLBOX oScroll VERTICAL HORIZONTAL SIZE nJanAltura / 2 - 20 , nJanLargur / 2 - 1 OF oDialogPvt
    # objeto0 - usando a classe TSay
    nObjLinha = 4
    nObjColun = 4
    nObjLargu = 40
    nObjAltur = 6
    oSayObj0 = TSay().New(nObjLinha, nObjColun, lambda : cSayObj0, oScroll, None, oFontPadrao, None, None, None, lDimPixels, None, None, nObjLargu, nObjAltur, None, None, None, None, None)
    # objeto1 - usando a classe TGet
    nObjLinha = 3
    nObjColun = 49
    nObjLargu = 100
    nObjAltur = 10
    oGetObj1 = TGet().New(nObjLinha, nObjColun, lambda u: ((xGetObj1 := u) if PCount() > 0 else xGetObj1), oScroll, nObjLargu, nObjAltur, None, None, None, None, oFontPadrao, None, None, lDimPixels)
    ...
    nObjLargu = 45
    nObjAltur = 6
    oSayObj2 = TSay().New(nObjLinha, nObjColun, lambda : cSayObj2, oScroll, None, oFontPadrao, None, None, None, lDimPixels, None, None, nObjLargu, nObjAltur, None, None, None, None, None)
    # objeto3 - usando a classe TGet
    nObjLinha = 18
    nObjColun = 49
    nObjLargu = 100
    nObjAltur = 10
    oGetObj3 = TGet().New(nObjLinha, nObjColun, lambda u: ((xGetObj3 := u) if PCount() > 0 else xGetObj3), oScroll, nObjLargu, nObjAltur, None, None, None, None, oFontPadrao, None, None, lDimPixels)
    ...
    nObjLargu = 45
    nObjAltur = 6
    oSayObj4 = TSay().New(nObjLinha, nObjColun, lambda : cSayObj4, oScroll, None, oFontPadrao, None, None, None, lDimPixels, None, None, nObjLargu, nObjAltur, None, None, None, None, None)
    # objeto5 - usando a classe TGet
    nObjLinha = 33
    nObjColun = 49
    nObjLargu = 100
    nObjAltur = 10
    oGetObj5 = TGet().New(nObjLinha, nObjColun, lambda u: ((xGetObj5 := u) if PCount() > 0 else xGetObj5), oScroll, nObjLargu, nObjAltur, None, None, None, None, oFontPadrao, None, None, lDimPixels)
    ...
    nObjLargu = 45
    nObjAltur = 6
    oSayObj6 = TSay().New(nObjLinha, nObjColun, lambda : cSayObj6, oScroll, None, oFontPadrao, None, None, None, lDimPixels, None, None, nObjLargu, nObjAltur, None, None, None, None, None)
    # objeto7 - usando a classe TGet
    nObjLinha = 48
    nObjColun = 49
    nObjLargu = 100
    nObjAltur = 10
    oGetObj7 = TGet().New(nObjLinha, nObjColun, lambda u: ((xGetObj7 := u) if PCount() > 0 else xGetObj7), oScroll, nObjLargu, nObjAltur, None, None, None, None, oFontPadrao, None, None, lDimPixels)
    ...
    nObjLargu = 45
    nObjAltur = 6
    oSayObj8 = TSay().New(nObjLinha, nObjColun, lambda : cSayObj8, oScroll, None, oFontPadrao, None, None, None, lDimPixels, None, None, nObjLargu, nObjAltur, None, None, None, None, None)
    # objeto9 - usando a classe TGet
    nObjLinha = 63
    nObjColun = 49
    nObjLargu = 100
    nObjAltur = 10
    oGetObj9 = TGet().New(nObjLinha, nObjColun, lambda u: ((xGetObj9 := u) if PCount() > 0 else xGetObj9), oScroll, nObjLargu, nObjAltur, None, None, None, None, oFontPadrao, None, None, lDimPixels)
    ...
    nObjLargu = 45
    nObjAltur = 6
    oSayObj10 = TSay().New(nObjLinha, nObjColun, lambda : cSayObj10, oScroll, None, oFontPadrao, None, None, None, lDimPixels, None, None, nObjLargu, nObjAltur, None, None, None, None, None)
    # objeto11 - usando a classe TGet
    nObjLinha = 78
    nObjColun = 49
    nObjLargu = 100
    nObjAltur = 10
    oGetObj11 = TGet().New(nObjLinha, nObjColun, lambda u: ((xGetObj11 := u) if PCount() > 0 else xGetObj11), oScroll, nObjLargu, nObjAltur, None, None, None, None, oFontPadrao, None, None, lDimPixels)
    ...
    nObjLargu = 45
    nObjAltur = 6
    oSayObj12 = TSay().New(nObjLinha, nObjColun, lambda : cSayObj12, oScroll, None, oFontPadrao, None, None, None, lDimPixels, None, None, nObjLargu, nObjAltur, None, None, None, None, None)
    # objeto13 - usando a classe TGet
    nObjLinha = 93
    nObjColun = 49
    nObjLargu = 100
    nObjAltur = 10
    oGetObj13 = TGet().New(nObjLinha, nObjColun, lambda u: ((xGetObj13 := u) if PCount() > 0 else xGetObj13), oScroll, nObjLargu, nObjAltur, None, None, None, None, oFontPadrao, None, None, lDimPixels)
