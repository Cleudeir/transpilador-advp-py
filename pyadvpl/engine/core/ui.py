...
def FWAlertInfo(msg: str, title: str = "Informação") -> None:
    """FWAlertInfo() — Exibe alerta de informação."""
    MsgInfo(msg, title)

def FWAlertWarning(msg: str, title: str = "Atenção") -> None:
    """FWAlertWarning() — Exibe alerta de aviso."""
    MsgAlert(msg, title)

def FWAlertSuccess(msg: str, title: str = "Sucesso") -> None:
    """FWAlertSuccess() — Exibe alerta de sucesso."""
    MsgInfo(msg, title)

def FWAlertYesNo(msg: str, title: str = "Confirmação") -> bool:
    """FWAlertYesNo() — Pergunta Sim/Não no estilo FW."""
    return MsgYesNo(msg, title)
...
def FWMsgRun(title: str, msg: str, func: Callable, *args: Any) -> Any:
